...
# Added the new gpu_only flag
parser.add_argument(
    "--gpu_only", action="store_true", help="Show only GPU usage and power"
)
...
def main():
    ...
    # UI Construction logic based on flag
    if args.gpu_only:
        ui = VSplit(
            gpu_gauge,
            gpu_power_chart,
            title=f"{soc_info_dict['name']} GPU Monitor",
            border_color=args.color,
        )
    else:
        ui = (
        ...
        while True:
            ...
            if ready:
                ...
                if timestamp > last_timestamp:
                    ...
                    # Update other metrics only if showing them
